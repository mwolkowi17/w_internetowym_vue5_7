...
<template>
  ...
  <SceneTrap
    ...
    @koniec-pulapka-focus="
      if_widok_pulapki = false;
      koniecPulapkiFocusOn();
    "
    rel="preload"
  ...
  />
  <SceneQuizz2
    v-if="if_widok_quizz2"
    @koniec-quizz="(if_widok_quizz2 = false), koniecQuizu()"
    @koniec-quizz-focus="(if_widok_quizz2 = false), koniecQuizuFocusOn()"
    @odejmij-szanse="odejmijSzanse"
    msg="Hej"
    :miejsceNaPlanszy="krok_gracz1_na_planszy"
    :ifButtonOnFocusQuizz2="ifQuizzFocusOn2"
    rel="preload"
  />
</template>
